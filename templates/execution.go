...
// ShowPostTemplate shows a template for a post
...
// ShowAuthorTemplate Shows the author template
...
// ShowTagTemplate shows the tag template
...
// ShowIndexTemplate shows the index template
